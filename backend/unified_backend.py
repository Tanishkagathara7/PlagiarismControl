#!/usr/bin/env python3
"""
Unified backend that serves both API and React frontend
"""
...
# Create FastAPI app
app = FastAPI(
    title="Plagiarism Control - Unified App",
    description="Code similarity detection for Jupyter notebooks",
    version="1.0.0"
)
...
@api_router.get("/")
async def root():
    return {"message": "PlagiarismControl API", "status": "running", "mode": "unified"}
        ...
        if index_file.exists():
            ...
            return JSONResponse(
                content={
                    ...
                    "exists": FRONTEND_BUILD_DIR.exists()
                },
                status_code=404
            )
...
if __name__ == "__main__":
    ...
    print(f"📁 Build Dir: {FRONTEND_BUILD_DIR}")
    print(f"📁 Build Exists: {FRONTEND_BUILD_DIR.exists()}")
