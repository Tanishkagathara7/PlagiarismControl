...
import { FileIcon, UploadIcon, BarChart3Icon, LogOutIcon } from 'lucide-react';

function Dashboard() {
  const [stats, setStats] = useState({ totalFiles: 0, lastAnalysis: null });
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
          ...
          <Card className="flex flex-col justify-between h-32 border-l-4 border-blue-500 bg-slate-50 p-4 stat-card" data-testid="stat-file-limit">
            ...
            <div className="font-mono text-3xl font-semibold text-slate-900">100</div>
          </Card>
          ...
          <Card className="flex flex-col justify-between h-32 border-l-4 border-amber-600 bg-slate-50 p-4 stat-card" data-testid="stat-threshold">
            ...
            <div className="font-mono text-3xl font-semibold text-slate-900">50%</div>
          </Card>
        </div>
